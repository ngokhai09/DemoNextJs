...
export default async function Page({params: {id}}: Params) {
    ...
    const suggestData = await axios.get("https://anphuocland.com:7100/api/v1/property?filter=%7B%22transactionTypeCode%22:%22SALE%22,%22isHome%22:true%7D")
    const forYou = suggestData.data.data.content;

    return (
        <Profiler id={"detail"} onRender={callback}>
                    ...
                    <div>
                        <div className="flex flex-col gap-2 mt-2">
                            ...
                            <div className="mt-2"><span
                                className="text-xl font-semibold text-gray-900">{house.title}</span>
                            </div>
                            <div><span
                            ...
                            <div className="mt-5">
                                <div className=" border-t-2 border-gray-200">
                                    <div className="grid grid-cols-5 my-2">
                                        <div><span
                                            className="text-sm text-gray-500 font-normal">Ngày đăng</span><br/><span
                                            className="text-sm text-gray-900 font-semibold">{new Date(house.createdOnDate).toLocaleDateString("en-GB")}</span>
                                        </div>
                                        <div><span
                                            className="text-sm text-gray-500 font-normal">Loại hình</span><br/><span
                            ...
                            <div className="grid grid-cols-5 gap-1 border-t border-b border-gray-200">
                                ...
                                <div className="col-span-1">
                                    <div className="mt-2"><label className="text-sm text-gray-400 font-normal">Diện
                                        tích</label></div>
                                    <div className="mt-1"><span
                                        className="text-sm text-gray-900 font-semibold"> {house.totalArea} m²</span>
                                    </div>
                                </div>
                                <div className="col-span-1">
                                    <div className="mt-2"><span
                            ...
                            <div className="mt-5"><span
                                className="text-lg font-medium text-gray-900">Thông tin mô tả</span>
                            </div>
                            <span
